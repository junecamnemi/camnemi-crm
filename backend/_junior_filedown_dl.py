...
scan = json.load(open(r"C:\Users\wisew\camnemi-crm\backend\_junior_scan_urls.json", encoding="utf-8"))
...
json.dump(results, open(r"C:\Users\wisew\camnemi-crm\backend\_junior_filedown_dl.json","w",encoding="utf-8"), ensure_ascii=False, indent=1)
