#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Parse the 206 NOT-yet-parsed guide PDFs with DeepSeek V4-Pro.
Only processes guides whose school is absent from guides_llm_parsed.jsonl.
Appends results to guides_llm_parsed.jsonl.
"""
import os, re, json, hashlib, urllib.request, ssl, sys
