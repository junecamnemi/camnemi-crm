...
OUTDIR = os.path.join(os.environ.get("LOCALAPPDATA",""), "Temp","bypass_mis")
BS = chr(92)
...
json.dump(all_paths, open(r"C:\Users\wisew\camnemi-crm\backend\_bypass_mis_structured.json","w",encoding="utf-8"), ensure_ascii=False, indent=1)
print("saved")
