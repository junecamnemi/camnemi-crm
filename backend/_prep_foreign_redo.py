...
reclass = json.load(open(r"C:\Users\wisew\camnemi-crm\backend\_junior_foreign_class.json", encoding="utf-8"))
...
for i,b in enumerate(batches):
    json.dump(b, open(rf"C:\Users\wisew\camnemi-crm\backend\_foreign_batch{i}.json","w",encoding="utf-8"), ensure_ascii=False, indent=1)
