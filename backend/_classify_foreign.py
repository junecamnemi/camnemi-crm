...
suspects = json.load(open(r"C:\Users\wisew\camnemi-crm\backend\_junior_need_foreign.json", encoding="utf-8"))
...
json.dump({"redownload":redownload,"keep":keep_with_sec}, open(r"C:\Users\wisew\camnemi-crm\backend\_junior_foreign_class.json","w",encoding="utf-8"), ensure_ascii=False, indent=1)
