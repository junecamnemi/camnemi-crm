...
print(f"실패 {len(fail)}")
json.dump({"ok":[r for r in res if r[1]=="ok"],"fail":[r[0] for r in fail]}, open(r"C:\Users\wisew\camnemi-crm\backend\_junior_render_par.json","w",encoding="utf-8"), ensure_ascii=False, indent=1)
