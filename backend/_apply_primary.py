...
d = json.load(open(r"C:\Users\USER\camnemi-crm\backend\_apply_systems_pdf.json", encoding="utf-8"))
...
json.dump(out, open(r"C:\Users\USER\camnemi-crm\backend\_apply_primary.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
