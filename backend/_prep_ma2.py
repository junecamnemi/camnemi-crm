...
need = json.load(open(r"C:\Users\wisew\camnemi-crm\backend\_all_gaps.json", encoding="utf-8"))["MA"]
...
for i in range(0,len(ma),7):
    b=ma[i:i+7]
    json.dump(b, open(rf"C:\Users\wisew\camnemi-crm\backend\_ma2_batch{i//7}.json","w",encoding="utf-8"), ensure_ascii=False, indent=1)
